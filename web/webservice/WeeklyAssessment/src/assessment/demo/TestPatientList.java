...
public class TestPatientList {
	public static void main(String[] args) {
		...
		// doubt in adding objects of patient class in tree set
		...
		//static method getPatientAge which accepts name of the patient and TreeSet of patient. Method should return the age of patient. Invoke this method in the 
